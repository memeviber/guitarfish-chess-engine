...
if __name__ == "__main__":
    try:
        model_file = sys.argv[1] if len(sys.argv) > 1 else "guitarfish_v2.gm"
        book_file = sys.argv[2] if len(sys.argv) > 2 else "book.bin"
        uci_loop(model_file, book_file)
